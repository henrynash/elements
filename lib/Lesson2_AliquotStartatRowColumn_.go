...
func _Lesson2_AliquotStartatRowColumnRequirements() {

}

// Conditions to run on startup
func _Lesson2_AliquotStartatRowColumnSetup(_ctx context.Context, _input *Lesson2_AliquotStartatRowColumnInput) {

}

// The core process for this protocol, with the steps to be performed
// for every input
func _Lesson2_AliquotStartatRowColumnSteps(_ctx context.Context, _input *Lesson2_AliquotStartatRowColumnInput, _output *Lesson2_AliquotStartatRowColumnOutput) {
...
func _Lesson2_AliquotStartatRowColumnAnalysis(_ctx context.Context, _input *Lesson2_AliquotStartatRowColumnInput, _output *Lesson2_AliquotStartatRowColumnOutput) {
}

// A block of tests to perform to validate that the sample was processed correctly
// Optionally, destructive tests can be performed to validate results on a
// dipstick basis
func _Lesson2_AliquotStartatRowColumnValidation(_ctx context.Context, _input *Lesson2_AliquotStartatRowColumnInput, _output *Lesson2_AliquotStartatRowColumnOutput) {

}
func _Lesson2_AliquotStartatRowColumnRun(_ctx context.Context, input *Lesson2_AliquotStartatRowColumnInput) *Lesson2_AliquotStartatRowColumnOutput {
	output := &Lesson2_AliquotStartatRowColumnOutput{}
	_Lesson2_AliquotStartatRowColumnSetup(_ctx, input)
	_Lesson2_AliquotStartatRowColumnSteps(_ctx, input, output)
	_Lesson2_AliquotStartatRowColumnAnalysis(_ctx, input, output)
	_Lesson2_AliquotStartatRowColumnValidation(_ctx, input, output)
	return output
}

func Lesson2_AliquotStartatRowColumnRunSteps(_ctx context.Context, input *Lesson2_AliquotStartatRowColumnInput) *Lesson2_AliquotStartatRowColumnSOutput {
	soutput := &Lesson2_AliquotStartatRowColumnSOutput{}
	output := _Lesson2_AliquotStartatRowColumnRun(_ctx, input)
...
func Lesson2_AliquotStartatRowColumnNew() interface{} {
	return &Lesson2_AliquotStartatRowColumnElement{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &Lesson2_AliquotStartatRowColumnInput{}
			...
			In:  &Lesson2_AliquotStartatRowColumnInput{},
			Out: &Lesson2_AliquotStartatRowColumnOutput{},
		},
	}
}
...
type Lesson2_AliquotStartatRowColumnElement struct {
	inject.CheckedRunner
}

type Lesson2_AliquotStartatRowColumnInput struct {
	ByRow            bool
...
type Lesson2_AliquotStartatRowColumnOutput struct {
	Aliquots      []*wtype.LHComponent
	WellPositions []string
}

type Lesson2_AliquotStartatRowColumnSOutput struct {
	Data struct {
		WellPositions []string
	}
	Outputs struct {
...
func init() {
	if err := addComponent(component.Component{Name: "Lesson2_AliquotStartatRowColumn",
		Constructor: Lesson2_AliquotStartatRowColumnNew,
		Desc: component.ComponentDesc{
			Desc: "Extra fields to Pre mix, and start at specific columns or rows. The lowest level example protocol Lessonshowing The MixTo command being used to specify the specific wells to be aliquoted to;\nBy doing this we are able to specify whether the aliqouts are pipetted by row or by column.\nIn this case the user is still not specifying the well location (i.e. A1) in the parameters, although that would be possible to specify.\nWe don't generally encourage this since Antha is designed to be prodiminantly a high level language which avoids the user specifying well locations but this possibility is there if necessary.\n",
			Path: "src/github.com/antha-lang/elements/AnthaAcademy/Lesson2_mix/F_AliquotSolutions_wellpositions.an",
